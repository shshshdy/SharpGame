...
layout(set = 1, binding = 0) uniform readonly UBO {
    mat4 view;
...
layout(set = 2, binding = 0, r8ui) uniform readonly uimageBuffer grid_flags;
layout(set = 2, binding = 2, r32ui) uniform readonly uimageBuffer grid_light_counts;
layout(set = 2, binding = 4, r32ui) uniform readonly uimageBuffer grid_light_count_offsets;
layout(set = 2, binding = 5, r32ui) uniform readonly uimageBuffer light_list;
