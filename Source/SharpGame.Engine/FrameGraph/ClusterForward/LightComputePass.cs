    ...
    public class LightComputePass : ComputePass
    {
        ...
        unsafe void DoCompute(ComputePass renderPass, RenderView view)
        {
            ...
            /*
                ...
                cmd_buf.BindDescriptorSets(PipelineBindPoint.Compute,
               ...
               // cmd_buf.writeTimestamp(PipelineStageFlags.ComputeShader, data.query_pool, QUERY_CALC_LIGHT_GRIDS * 2 + 1);
                ...
                cmd_buf.bindPipeline(PipelineBindPoint::eCompute, pipelines_.calc_grid_offsets);
                pipeline_desc_sets_.calc_grid_offsets[0] = data.desc_set;
                cmd_buf.bindDescriptorSets(PipelineBindPoint::eCompute,
                ...
                cmd_buf.bindPipeline(PipelineBindPoint::eCompute, pipelines_.calc_light_list);
