...
namespace SharpGame
{
    ...
    public class SJSON
    {
        ...
        /// </summary>
        public static JSElement Decode(byte[] sjson)
        {
            int index = 0;
        ...
        /// </summary>
        public static void WriteRootObject(JSElement t, StringBuilder builder)
        {
        ...
        /// </summary>
        public static void WriteObjectField(JSElement t, string key, StringBuilder builder, int indentation)
        {
        ...
        /// </summary>
        public static void WriteObjectFields(JSElement t, StringBuilder builder, int indentation)
        {
        ...
        public static void Write(object o, StringBuilder builder, int indentation)
        {
            ...
            else if (o is JSElement)
                WriteObject((JSElement)o, builder, indentation);
            else
        ...
        /// </summary>
        public static void WriteObject(JSElement t, StringBuilder builder, int indentation)
        {
            builder.Append('{');
        ...
        static JSElement ParseRootObject(byte[] json, ref int index)
        {
        ...
        static JSElement ParseObject(byte[] json, ref int index)
        {
            JSElement ht = new JSElement();
            Consume(json, ref index, "{");
            SkipWhitespace(json, ref index);
        ...
        static Double ParseNumber(byte[] json, ref int index)
        {
            ...
            index = end;
            String numstr = Encoding.UTF8.GetString(num);
