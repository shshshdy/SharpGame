...
namespace SharpGame
{
    public class FramebufferAttachment : DisposeBase, IBindableResource
    {
        public Image image;
        ...
        public FramebufferAttachment(uint width, uint height, uint layers, Format format, ImageUsageFlags usage, ImageAspectFlags aspectMask,
